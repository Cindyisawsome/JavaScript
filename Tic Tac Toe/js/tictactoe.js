...
let activePlayer = 'X';
//This array stores an array of moves. We use this to determine win cinditions.
let selectedSquares = [];

//This function is for placing an x or i on a square.
...
function checkWinConditions() {
    ...
    //O 6,4,2 condition.
    else if(arrayIncludes('6O','4O','2O'))  {drawWinLine(100,558,510,90); }
    //O 0,4,8 condition.
...
//This function untilizes html canvas to draw win lines.
function drawWinLine (coordX1, coordY1,coordX2,coordY2) {
    //This line accesses our html canvas element.
    const canvas = document.getElementById('win-lines');
    //This line gives us access to methids and properties to use on canvas.
...
function resetGame() {
    ...
    for (let i = 0; i < 9; i++)  {
        //This variable gets the html elements of i.
