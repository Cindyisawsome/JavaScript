...
function Handle_Operator(Next_Operator)  {
    ...
    //checks if an operator already exist and id Wait_Second_Operand is ture,
    ...
    if (First_Operand == null ) {
        ...
        // in the Perform_Calculation object and the function that matchs the 
...
keys.addEventListener('click',(event) => {
    //the target varible is an object that represents tha element
    //that was clicked
    const { target } = event;
